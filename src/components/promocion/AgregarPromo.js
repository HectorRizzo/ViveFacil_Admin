...
const AgregarPromocion = (props) => {
    ...
    const handleChangepaticipantes = (event) => {
        param.participantes0 = event.target.value
        //console.log(param.participantes0)
        var parti = document.getElementById("errorparticipantes0");
          ...
          <div className="column-1">*/}
                ...
                <Form {...layout} form={form} onSubmit={handleSubmitted()} >
                    ...
                    <Form.Item
                        ...
                        className="form"
                    >
                        {/*<Input initialValues="" className="input" onChange={value => { handleChangepaticipantes(value) }} />
                        <div className="Registroerror-div">
                            <label className="error" id="errorparticipantes0"></label>
        </div>*/}
                        <select className="select-prom"
                            name="participantes"
                            onChange={value => { handleChangepaticipantes(value) }}
                            required>
                            <option selected="true" disabled="disabled">seleccione el participante</option>
